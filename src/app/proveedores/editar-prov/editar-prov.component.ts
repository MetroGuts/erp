...
export class EditarProvComponent implements OnInit {
  ...
  constructor(private pf: FormBuilder,
              ...
              private route: ActivatedRoute) { // para poder leer y extraer el parametro que se carga en la barra de navegacion ( en este caso el id del proveedor)
                if(!this.proveedor){ //para corregir un error que salta en la consola del navegador cuando esta realizando la peticion de datos el ducumento lo esta leyendo y aun no lo ha encontrado
                  this.proveedor = {}
                }
              } 

    ngOnInit() {
      // carga el parametro extraido de la barra de navegacion y lo enchufa en cargarProveedor para mostrarlo en pantalla
